  ...
  if (contactForm) {
    ...
    function getErrorMessage(field, rule, ruleValue) {
      const label = field.closest('[class*="field"], [class*="group"], label, div')
        ?.querySelector('label')?.textContent?.trim() || field.name || 'This field';
    ...
    function validateField(field) {
      ...
      for (const rule of rules) {
        ...
        if (validator && !validator(field.value, ruleValue)) {
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Liron Barber Shop משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '6edac4af-b37c-4a36-a5d8-0ad6e35c8603',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '6edac4af-b37c-4a36-a5d8-0ad6e35c8603';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '6edac4af-b37c-4a36-a5d8-0ad6e35c8603';
